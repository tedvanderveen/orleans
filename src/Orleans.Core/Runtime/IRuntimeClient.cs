...
namespace Orleans.Runtime
{
    ...
    internal interface IRuntimeClient
    {
        ...
        void SendRequest(GrainReference target, InvokeMethodRequest request, Action<Response, object> responseCallback, object context, string debugContext = null, InvokeMethodOptions options = InvokeMethodOptions.None, string genericArguments = null);
