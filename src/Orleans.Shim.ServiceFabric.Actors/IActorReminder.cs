...
{
    /// <summary>
    /// Represents a reminder registered using <see cref="Orleans.ServiceFabric.Actors.Runtime.ActorBase.RegisterReminderAsync" />.
    /// </summary>
    public interface IActorReminder
    {
        ...
        /// <remarks>
        /// The first invocation of the reminder occurs after <see cref="Microsoft.ServiceFabric.Actors.Runtime.IActorReminder.DueTime" />. All subsequent invocations occur at intervals defined by this property.
        /// </remarks>
        TimeSpan Period { get; }
